    ...
    public class SymbolService
    {
        ...
        private List<Symbol> InitializeDefaultSymbols()
        {
            return new List<Symbol>
            {
                ...
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000017"), Name = "序号标识(阳)", HalfWidth = "º", FullWidth = "º", IsPaired = false, IsDefault = true },
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000018"), Name = "序号标识(阴)", HalfWidth = "ª", FullWidth = "ª", IsPaired = false, IsDefault = true },
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000019"), Name = "千分号", HalfWidth = "‰", FullWidth = "‰", IsPaired = false, IsDefault = true },
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000020"), Name = "万分号", HalfWidth = "‱", FullWidth = "‱", IsPaired = false, IsDefault = true },
                ...
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000025"), Name = "段落符号", HalfWidth = "¶", FullWidth = "¶", IsPaired = false, IsDefault = true },
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000026"), Name = "分节符号", HalfWidth = "§", FullWidth = "§", IsPaired = false, IsDefault = true },
                ...
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000031"), Name = "版权符号", HalfWidth = "©", FullWidth = "©", IsPaired = false, IsDefault = true },
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000032"), Name = "注册商标符号", HalfWidth = "®", FullWidth = "®", IsPaired = false, IsDefault = true },
                new Symbol { Id = Guid.Parse("00000001-0000-0000-0000-000000000033"), Name = "商标符号", HalfWidth = "™", FullWidth = "™", IsPaired = false, IsDefault = true },
            };
        }
    }
}